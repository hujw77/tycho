...
pub(crate) struct PreparedFamilyRunnerDraft {
...
impl PreparedFamilyRunnerDraft {
...
pub(crate) fn family_auxiliary_protocol_state_hydrators_by_protocol_system<'a>(
    family: &'a ResolvedFamilyRuntime<'a>,
) -> &'a HashMap<
    String,
...
async fn build_extractors_for_family(
    ...
    extractor_build
        .build_protocol_system_keyed_extractors(
            ...
            family_auxiliary_protocol_state_hydrators_by_protocol_system(family),
        )
        .await
}
